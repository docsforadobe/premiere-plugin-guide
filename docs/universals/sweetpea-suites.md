...
| `ioPPix`                    | The frame into which to draw the overlay. If NULL, the host will allocate the PPix.<br/><br/>If provided, the PPix must be BGRA, square pixel aspect ratio, and sized to inDisplayWidth & inDisplayHeight. |
