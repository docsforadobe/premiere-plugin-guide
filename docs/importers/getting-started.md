...
| **Member**       | **Description**                                                                                                                                                                                                                                                                                                                                                                   |
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `imInterfaceVer` | Importer API version<br/><br/>- Premiere Pro CC 2014 - `IMPORTMOD_VERSION_15`<br/>- Premiere Pro CC - `IMPORTMOD_VERSION_14`<br/>- Premiere Pro CS6.0.2 - `IMPORTMOD_VERSION_13`<br/>- Premiere Pro CS6 - `IMPORTMOD_VERSION_12`<br/>- Premiere Pro CS5.5 - `IMPORTMOD_VERSION_11`<br/>- Premiere Pro CS5 - `IMPORTMOD_VERSION_10`<br/>- Premiere Pro CS4 - `IMPORTMOD_VERSION_9` |
